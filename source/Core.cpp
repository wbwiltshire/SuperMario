...
CCore::CCore(void) {
	...
	//Add Game Controller inilialization
	...
	if (gGameController == NULL)
	{
		...
		printf("Info: Game controller loaded!\n");
	}
...
CCore::~CCore(void) {
	...
	if (gGameController) {
		...
		printf("Info: Game controller unloaded!\n");
...
void CCore::InputPlayer() {
	...
	//Add code for Game Controller input
	if (mainEvent->type == SDL_CONTROLLERBUTTONUP) {
		...
		case SDL_CONTROLLER_BUTTON_A:
			...
			//printf("Info: Game Controller button DPAD_A(%d) released\n", mainEvent->cbutton.button);
			break;
	...
	if (mainEvent->type == SDL_CONTROLLERBUTTONDOWN) {
		...
		case SDL_CONTROLLER_BUTTON_A:
			...
			//printf("Info: Game Controller button DPAD_A(%d) pressed\n", mainEvent->cbutton.button);
			break;
		case SDL_CONTROLLER_BUTTON_B:
			if (!keyShift) {
				oMap->getPlayer()->startRun();
